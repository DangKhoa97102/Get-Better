...
<footer class="py-3 px-2 tm-bg-gray">
	<div class="d-flex justify-content-between align-items-center border-bottom pb-3">
		...
		<ul class="nav">
			<li class="nav-item">
				<a class="nav-link" href="?lang=en"><span class="flag-icon flag-icon-gb-eng"></span> English</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="?lang=vi"><span class="flag-icon flag-icon-vn"></span> Tiếng Việt</a>
			</li>
		</ul>
	</div>
